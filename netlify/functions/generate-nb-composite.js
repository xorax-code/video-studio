...
CASE A — Photo 1 shows a person's FACE or BODY: Completely replace that person's identity AND their clothing with the Photo 2 avatar — exact face, skin tone, hair, hands, body type, and OUTFIT. The person in the output must look like Photo 2 and must be wearing the avatar's OWN clothing (for example her tank top), NOT the original person's shirt. Match the avatar's gender and skin: if the avatar is a woman, give her smooth, feminine, hairless arms and hands — remove any arm hair, coarse hair, stubble, or masculine features from the original person. Integrate them so they look naturally part of this scene, not pasted: match Photo 1's lighting direction and color temperature, shadow softness, perspective, and depth of field; add natural contact shadows and blended edges; no cut-out halo or sticker look. Render the person as a lightly STYLIZED, premium digital portrait — smooth idealized skin and soft flattering light, clearly NOT a literal photograph of a real individual (this is what keeps Veo from blocking the frame as a real person under code 15236754), while keeping natural human proportions and the avatar's clearly-recognizable identity. Avoid hyperreal skin pores and harsh documentary detail; keep it tasteful, attractive, and premium — a polished lifestyle 3D-render / editorial look, NOT a hard cartoon or anime.
...
- If Photo 1 contains a visible person (face and/or body): replace ONLY that person's identity with Photo 2's appearance, and integrate them so they look naturally part of the scene — match the lighting, color, shadows, perspective and depth of field; do not let them look pasted or cut-out. Render the person as a lightly STYLIZED, premium digital portrait — smooth idealized skin and soft flattering light, clearly NOT a literal photograph of a real individual (this is what keeps Veo from blocking the frame as a real person under code 15236754), while keeping natural human proportions and the avatar's clearly-recognizable identity. Avoid hyperreal skin pores and harsh documentary detail; keep it tasteful, attractive, and premium — a polished lifestyle 3D-render / editorial look, NOT a hard cartoon or anime.
...
Hard rules: never add a second person or any human figure that was not already in Photo 1. Keep Photo 1's background, setting, and lighting. FRAMING — when Photo 1 shows a PERSON, frame the output WIDER than Photo 1: pull the camera back to a medium shot so the person is roughly waist-up and the FACE is small in the frame (a face filling the frame trips Veo's person filter). Do NOT crop in tighter than Photo 1. EXCEPTION: if Photo 1 is a hand/arm-only product shot with no face, keep its exact crop unchanged.${hasProduct ? ' Replace the product held in the hand with the exact product from Photo 3 (same hand, grip, and scale).' : ''} Always remove any burned-in text, captions, or subtitles.`
