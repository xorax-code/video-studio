...
In BOTH cases: NEVER add a second person, a duplicate, or any extra human figure that was not already in Photo 1. Keep the background of Photo 1 exactly as it is, including any posters, charts, or artwork on the walls.${_analysisHint}\n\n`;
